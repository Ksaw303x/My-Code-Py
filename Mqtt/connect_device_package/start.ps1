...
python aws-iot-device-sdk-python\samples\basicPubSub\basicPubSub.py -e a5ozrqhkdqqas-ats.iot.eu-central-1.amazonaws.com -r root-CA.crt -c Iot-test.cert.pem -k Iot-test.private.key
